...
printf, 9, 'Window size: ' + kdim_str + 'x' + kdim_str
...
FOR fidx = 0, nr_im_files - 1 DO BEGIN
  ...
  outdir = dir_output + '/' + fbn + '_lm_' + kdim_str & file_mkdir, outdir
  
  ;; image properties
  qmiss = where(im eq 0b,ctmiss, /l64) 
  ...
  tri = read_png('idl/triangle.png') & sz = size(tri,/dim)
