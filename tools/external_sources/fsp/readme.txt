...
In addition to the files provided here, compilation of fsp.c requires the following files 
from the miallib repository: https://github.com/ec-jrc/jeolib-miallib
- miallib.h
- mialtypes.h
- op.h
...
Then run the included make file to compile mspa_lin64 for use in GTB/GWB.
